...
class AdminRoute
{
    public function map(Registrar $router)
    {
        $router->group([
            ...
            // Config
            $router->get ('/config/myfetch', 'Admin\\ConfigController@fetch');
            ...
            // Plan
            $router->get ('/plan/myfetch', 'Admin\\PlanController@fetch');
            ...
            // Server
            $router->get ('/server/group/myfetch', 'Admin\\Server\\GroupController@fetch');
            ...
            // Order
            $router->get ('/order/myfetch', 'Admin\\OrderController@fetch');
            ...
            // User
            $router->get ('/user/myfetch', 'Admin\\UserController@fetch');
            ...
            // Coupon
            $router->get ('/coupon/myfetch', 'Admin\\CouponController@fetch');
            ...
            // Payment
            $router->get ('/payment/myfetch', 'Admin\\PaymentController@fetch');
